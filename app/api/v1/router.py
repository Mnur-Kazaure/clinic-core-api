...
from . import auth, patient, visit, consultation, lab, pharmacy, lab_request, prescriptions, clinic_registration, clinic_profile, clinic_staff, user, doctor_lab, admissions, beds, wards, priority, identity, audit_review, billing, pmr, admin, anc, maternity
