...
class TriageService:
    ...
    def get_active_assessment(self, *, visit_id: UUID, current_user) -> TriageAssessment | None:
        ...
        return self._active_assessment(visit_id=visit.id)

    def has_active_assessment(self, *, visit_id: UUID) -> bool:
        return self._active_assessment(visit_id=visit_id) is not None

    def _active_assessment(self, *, visit_id: UUID) -> TriageAssessment | None:
        return (
