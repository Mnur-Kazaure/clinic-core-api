...
#     VisitStatus.WAITING: [VisitStatus.CONSULTING, VisitStatus.CANCELLED],
#     VisitStatus.CONSULTING: [
#         VisitStatus.LAB,
#         VisitStatus.PHARMACY,
#         VisitStatus.COMPLETED,
#     ],
#     VisitStatus.LAB: [VisitStatus.PHARMACY, VisitStatus.COMPLETED],
#     VisitStatus.PHARMACY: [VisitStatus.COMPLETED],
# }


# ROLE_TRANSITION_MATRIX = {
#     UserRole.RECEPTION: [VisitStatus.WAITING, VisitStatus.CANCELLED],
#     UserRole.DOCTOR: [
#         VisitStatus.CONSULTING,
#         VisitStatus.LAB,
#         VisitStatus.PHARMACY,
...
#     # # 2️⃣ Transition validity
#     # allowed = ALLOWED_TRANSITIONS.get(visit.status, [])
...
#     # allowed_for_role = ROLE_TRANSITION_MATRIX.get(user.role, [])
#     # if to_status not in allowed_for_role:
#     #     raise PermissionError("Role not allowed to perform this transition")
...
# def _ensure_no_labs_or_prescriptions(db, visit: Visit):
#     lab_count = (
#         db.query(LabRequest)
#         .filter(LabRequest.visit_id == visit.id)
#         .count()
